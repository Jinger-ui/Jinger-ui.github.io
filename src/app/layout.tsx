  ...
  return (
    <html lang={runtimeI18n.defaultLocale} className="scroll-smooth" suppressHydrationWarning>
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Allura&family=Cormorant+Garamond:wght@400;600;700&display=swap"
          rel="stylesheet"
        />
        <script
      ...
      <body className="font-sans antialiased">
        <ThemeProvider>
          <LocaleProvider config={runtimeI18n}>
            ...
            />
            <main className="min-h-screen pt-16 lg:pt-20 snap-y snap-proximity scroll-smooth">
              {children}
            </main>
            <Footer
